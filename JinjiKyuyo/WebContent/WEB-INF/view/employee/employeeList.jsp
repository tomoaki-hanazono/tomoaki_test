...
<form name="nextForm" method="post" action="/JinjiKyuyo/employee/list" class="center">
	...
	<input type="button" name="next" id="salaryInfo" value="給与情報一覧" class="button" onClick="moveNext(this)" disabled="disabled">
	<br>
	<table class="employeeListAria">
		<tr><th class="w0"></th><th class="w1">氏名</th><th class="w1">生年月日</th><th class="w1">郵便番号</th><th class="w2">住所</th><th class="w1">固定電話番号</th><th class="w1">携帯電話番号</th><th class="w2">メールアドレス</th></tr>
